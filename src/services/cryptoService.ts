/**
 * Client-side message encryption using Web Crypto API.
 *
 * The database stores only ciphertext for text messages. Key exchange is still
 * intentionally lightweight for the current app architecture, but encryption
 * failures must not silently downgrade a text message to plaintext.
 */
