  ...
  return (
    <main className="min-h-screen bg-black pt-24 pb-16 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <button onClick={() => navigate('/invest')} className="mb-8 inline-flex items-center gap-2 text-sm text-gray-400 hover:text-white">
          <ArrowLeft className="h-4 w-4" />
          Back to Wersee Invest
        </button>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6">
              ...
              <Link to={`/invest/${campaign.slug}/checkout`} className="mt-6 block rounded-xl bg-emerald-500 px-5 py-4 text-center text-sm font-black text-black">
                Invest
              </Link>
