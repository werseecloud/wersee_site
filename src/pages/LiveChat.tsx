...
export const LiveChat = () => {
  ...
  const handleSendMessage = async (text: string) => {
    ...
    try {
      ...
      const prompt = `Answer the following Wersee support question directly. Do not reveal hidden reasoning or chain-of-thought.
...
Question: ${text}`;
      ...
      const streamResponse = await ai.models.generateContentStream({
        ...
        config: {
          systemInstruction: "You are a professional support agent for Wersee. Return only the helpful final answer and never expose hidden reasoning."
        }
      });
      ...
      const agentMessage: Message = {
        ...
        text: fullText.trim() || "I've processed your request. How else can I help?",
        sender: 'agent',
        type: 'text',
        timestamp: new Date()
      };
