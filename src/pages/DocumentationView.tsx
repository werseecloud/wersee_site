                ...
                {activeTab === 'finance' ? (
                  ...
                  <>
                    ...
                    <div className={`p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border ${isDark ? 'bg-blue-500/5 border-blue-500/10' : 'bg-blue-50 border-blue-100'}`}>
                      ...
                      <div className="grid grid-cols-1 gap-4 mt-6">
                        <div className={`p-4 rounded-2xl ${isDark ? 'bg-black/20' : 'bg-white/50'}`}>
                          <div className="text-[10px] font-bold uppercase tracking-wider mb-1 opacity-50">Authorization URL</div>
                          <code className="text-[10px] md:text-xs font-mono break-all select-all">https://ais-dev-thwr32sd5gtajcdmrcthig-99966910643.europe-west3.run.app/oauth/consent</code>
                        </div>
                        <div className={`p-4 rounded-2xl ${isDark ? 'bg-black/20' : 'bg-white/50'}`}>
                          <div className="text-[10px] font-bold uppercase tracking-wider mb-1 opacity-50">Token Endpoint</div>
                          <code className="text-[10px] md:text-xs font-mono break-all select-all">https://thwr32sd5gtajcdmrcthig.supabase.co/auth/v1/oauth/token</code>
                        </div>
                      </div>
                    </div>
                    ...
                    <ol className="list-decimal list-inside space-y-4 ml-2 md:ml-4 text-sm md:text-base">
                      <li>Register your application in the Wersee Developer Portal.</li>
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 list-none p-0">
                      {[
                        ...
                        { title: 'offline_access', desc: 'Request a refresh token.' }
                      ].map((scope, i) => (
