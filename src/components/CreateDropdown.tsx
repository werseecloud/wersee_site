...
import { Briefcase, Package, Sparkles, FileText, X, Users, Globe, Megaphone, Calculator, Smartphone } from 'lucide-react';
                ...
                {options.map((option) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 relative z-10">
                      <h4 className="font-black italic uppercase tracking-tight text-base group-hover:translate-x-1 transition-transform text-white">
                        {option.title}
                      </h4>
