          ...
          <aside className="lg:col-span-5">
            <div className="sticky top-28 space-y-6">
              <div className="rounded-3xl border border-white/10 bg-[#141414] p-7 shadow-2xl">
                ...
                <Link to={tryUserProfilePath(listing.seller_handle) || '/'} className="mt-3 block text-sm font-medium text-indigo-300 hover:underline">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <LocalizedPrice amount={minor / 100} baseCurrency={price?.currency || 'EUR'} className="font-semibold" showOriginal={false} />
                        </div>
                ...
                <div className="mt-7 flex items-baseline justify-between border-t border-white/10 pt-6">
                  ...
                  <LocalizedPrice amount={priceMinor / 100} baseCurrency={currency} className="text-4xl font-semibold tracking-normal text-white" />
                </div>
