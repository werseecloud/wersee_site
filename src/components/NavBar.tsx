    ...
    <>
      <motion.header 
        ...
        className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 border-b ${
          scrolled 
            ? 'bg-black/80 border-white/10 backdrop-blur-2xl py-2'
            : 'bg-transparent border-transparent py-4'
        }`}
      >
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-14 sm:h-16">
            {/* Mobile Header (Logo - Menu - Create) */}
            <div className="flex sm:hidden items-center justify-between w-full h-full">
              ...
              <button
                ...
                className="flex flex-col items-center justify-center gap-1 w-10 h-10 rounded-2xl bg-white/5 text-white border border-white/10 active:scale-90 transition-all hover:bg-white/10"
              >
              ...
              <button 
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-2xl bg-white text-black text-[10px] font-black italic uppercase tracking-widest shadow-[0_10px_20px_rgba(255,255,255,0.1)] active:scale-95 transition-all hover:bg-gray-100"
              >
                {user ? <Plus className="w-3 h-3" /> : <User className="w-3 h-3" />}
            ...
            <div className="hidden sm:flex items-center justify-between w-full h-full">
              ...
              {location.pathname.startsWith('/workspace') && (
                <Link 
                  to="/" 
                  className="flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-500/10 text-blue-400 border border-blue-500/20 hover:bg-blue-500/20 transition-all text-sm font-bold"
                >
              ...
              <AnimatePresence initial={false}>
                {showSearch && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, width: 'clamp(240px, 24vw, 380px)', scale: 1 }}
                  ...
                  >
                    <form onSubmit={handleSearch} className="group relative">
                      ...
                      <input
                        ...
                        className="h-10 w-full rounded-full border border-white/10 bg-white/[0.06] pl-10 pr-10 text-sm font-medium text-white outline-none transition-all placeholder:text-gray-500 hover:border-white/15 hover:bg-white/[0.08] focus:border-blue-400/40 focus:bg-white/[0.1] focus:ring-2 focus:ring-blue-500/15"
                      />
                      {searchQuery && (
                        <button
                          type="button"
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <Link
                  to="/checkout"
                  className={`flex p-2.5 rounded-xl transition-all hover:scale-110 active:scale-90 relative text-white hover:bg-white/10`}
                >
                ...
                {user ? (
                  ...
                  <Link 
                    to="/auth"
                    className={`flex px-5 py-2.5 rounded-full text-sm font-bold transition-all hover:scale-105 active:scale-95 text-white hover:bg-white/10`}
                  >
                    Sign In
                  </Link>
                )}
                ...
                <button 
                  onClick={() => user ? setIsCreateOpen(true) : navigate('/auth')}
                  className={`hidden sm:flex items-center gap-3 px-6 py-2.5 rounded-full text-sm font-black italic uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-2xl group relative overflow-hidden bg-white text-black hover:bg-gray-200 shadow-white/10`}
                >
