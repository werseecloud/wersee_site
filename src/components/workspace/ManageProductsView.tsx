    ...
    <div className="space-y-6 max-w-7xl mx-auto p-4 md:p-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button 
          onClick={() => {
            let type = 'physical';
            if (activeTab === 'bundles') type = 'bundle';
            else if (activeTab === 'courses') type = 'digital';
            onEdit?.(`create?type=${type}`);
          }}
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="text-center py-16 bg-[#141414] rounded-3xl border border-dashed border-white/10">
            ...
            <button 
              onClick={() => {
                const type = activeTab === 'bundles' ? 'bundle' : 'product';
                onEdit?.(`create?type=${type}`);
              }}
                  ...
                  <div className="flex-1 min-w-0 flex flex-col">
                    ...
                    <div className="mt-auto flex flex-col sm:flex-row items-start sm:items-center justify-between pt-4 gap-4 sm:gap-0 border-t border-white/5 sm:border-none">
                      ...
                      <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                        ...
                        <button className="flex-1 sm:flex-none p-2.5 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-xl border border-white/5 transition-all flex justify-center">
