  ...
  const handleSendInvoice = async () => {
    ...
    try {
      ...
      if (proposal.accepted_invoice_id) {
        ...
        if (existingInvoice) {
          const existingLink = `${window.location.origin}/sandbox/pay/invoice/${existingInvoice.username}/${existingInvoice.invoice_number || existingInvoice.slug}`;
      ...
      const paymentLink = `${window.location.origin}/sandbox/pay/invoice/${username}/${invoice.invoice_number}`;
      await supabase
        .from('invoice_links')
