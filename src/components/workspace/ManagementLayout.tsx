...
import { Package, TrendingUp, Users, Zap, Settings, ChevronRight, Mail, Megaphone, CreditCard, Layout, MessageSquare, ShoppingCart, StickyNote, Globe, Filter, Beaker, Gift, Handshake, FileText, Shield, Briefcase, ShieldCheck, Search, X, Phone, Gauge } from 'lucide-react';
...
export const ManagementLayout: React.FC<ManagementLayoutProps> = ({ children, activeView, onNavigate, businessId }) => {
  ...
  const menuItems = [
    ...
    { id: 'management-legal', label: 'Legal & Compliance', icon: Shield, category: 'product' },
    { id: 'management-plans', label: 'Plans', icon: CreditCard, category: 'product' },
    { id: 'management-site-editor', label: 'Site Editor', icon: Layout, category: 'product' },
    ...
    { id: 'management-workflows', label: 'Workflows', icon: Zap, category: 'product' },
