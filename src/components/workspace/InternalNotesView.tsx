...
import { StickyNote, Plus, Search, Trash2, Edit2, Save, X, User, Calendar, Filter } from 'lucide-react';
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button onClick={handleSaveNote} className="px-6 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl font-bold transition-colors">Save Note</button>
              </div>
            </div>
          </motion.div>
        )}
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-end gap-4 pt-4">
                  ...
                  <button 
                    ...
                    className="px-8 py-2.5 bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl font-bold transition-all flex items-center gap-2"
                  >
