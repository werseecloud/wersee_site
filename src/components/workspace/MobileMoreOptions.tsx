      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-[101] bottom-0 left-0 right-0 bg-[#0F0F0F] rounded-t-[3rem] border-t border-white/10 overflow-hidden flex flex-col max-h-[92vh] md:hidden shadow-[0_-20px_50px_rgba(0,0,0,0.5)]"
          >
            {/* Handle */}
