...
export const SiteEditorView: React.FC<{ businessIdOverride?: string; embedded?: boolean }> = ({ businessIdOverride, embedded = false }) => {
  const { businessId: routeBusinessId } = useParams();
  const businessId = businessIdOverride || routeBusinessId;
  ...
  return (
    <div className={`${embedded ? 'bg-[#0a0a0a]' : 'max-w-7xl mx-auto'} p-4 md:p-8`}>
