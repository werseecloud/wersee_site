            ...
            >
              ...
              <div className="bg-[#141414] border border-white/5 rounded-[2.5rem] overflow-hidden">
                ...
                <div className="divide-y divide-white/5">
                  {[
                    { action: 'Terms Updated', date: '2 hours ago', user: 'You' },
                    { action: 'Privacy Policy Reviewed', date: '1 day ago', user: 'System' },
                    { action: 'Business Info Verified', date: '3 days ago', user: 'Wersee Compliance' },
                  ].map((log, i) => (
                    <div key={i} className="p-4 flex items-center justify-between hover:bg-white/[0.02] transition-colors">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-gray-500 uppercase tracking-widest font-bold">{log.user}</div>
                        </div>
                      </div>
