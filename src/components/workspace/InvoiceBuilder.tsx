            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white font-mono text-sm truncate">
                  {werseePaymentUrls.invoice({ username: createdInvoice.username, invoiceId: createdInvoice.invoice_number })}
                </div>
                <button 
                  onClick={() => {
                    navigator.clipboard.writeText(werseePaymentUrls.invoice({ username: createdInvoice.username, invoiceId: createdInvoice.invoice_number }));
                    setCopied(true);
