  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 mb-6 z-10">
        ...
        <div>
          <h3 className="text-white font-black uppercase tracking-widest text-[10px] mb-1">{announcement.creator_name || 'User'}</h3>
      ...
      {/* Title */}
      <h4 className="text-2xl font-black italic uppercase tracking-tighter text-white mb-3 z-10 line-clamp-2 leading-[0.9] group-hover:text-indigo-400 transition-colors">
        {announcement.title}
      </h4>
