      ...
      >
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-gray-900">{job.author?.name || 'User'}</p>
              <p className="text-xs text-gray-500">Posted {job.postedAt || 'recently'}</p>
            </div>
          </div>
          <button aria-label={`More options for ${job.title}`} className="text-gray-400 hover:text-gray-600 transition-colors">
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-6">
        ...
        <button aria-label={`Save ${job.title}`} className="text-gray-400 hover:text-white transition-colors">
