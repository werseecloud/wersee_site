          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
              ...
              <div className="space-y-2">
                {results.products.length > 0 ? (
                  results.products.map((item) => (
                    <Link
                      key={item.id}
                      to={`/@${item.profiles?.username}/${item.slug}`}
                      onClick={onClose}
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <Link to="/creators" onClick={onClose} className="flex items-center gap-2 pt-1 text-xs text-gray-400 transition-colors hover:text-white">
                  Discover Creators <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </div>
          </div>
