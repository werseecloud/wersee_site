import{g as f}from"./geminiClient-BgWqbQn7.js";const d=()=>f(),u=async e=>{const l=/https?:\/\/[^\s]+/g,o=e.match(l);if(!o||o.length===0)return{safe:!0,cleanedContent:e};const a=d();try{if(!a)throw new Error("GEMINI_API_KEY not configured");const r=await a.models.generateContent({model:"gemini-3-flash-preview",contents:`
...
//# sourceMappingURL=chatAiService-0txX5-_d.js.map
